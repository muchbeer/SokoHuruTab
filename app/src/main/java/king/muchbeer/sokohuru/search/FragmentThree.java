package  king.muchbeer.sokohuru.search;
...
import  king.muchbeer.sokohuru.*;
import  king.muchbeer.sokohuru.MainActivity;
import  king.muchbeer.sokohuru.Sokoni.MyApplication;
import  king.muchbeer.sokohuru.connectdata.AppConfig;
import  king.muchbeer.sokohuru.connectdata.SessionManager;
              ...
              //  edtDesc.setText("");
                ...
                if(pointError.contains("Ongera")) {
                    ...
                    Intent getBackToMainActivity = new Intent(getActivity(),
                             king.muchbeer.sokohuru.MainActivity.class);
